...
class ConfigDetail5 extends StatefulWidget {
  final String total;
  final Map<String, dynamic> pc;
  const ConfigDetail5({super.key, required this.pc, required this.total});

  @override
  State<ConfigDetail5> createState() => _ConfigDetail5State();
}

class _ConfigDetail5State extends State<ConfigDetail5> {
  @override
