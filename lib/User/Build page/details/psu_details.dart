...
class ConfigDetail8 extends StatefulWidget {
  final Map<String, dynamic> pc;
  final String totalAmt;
  const ConfigDetail8({super.key, required this.pc, required this.totalAmt});

  @override
  State<ConfigDetail8> createState() => _ConfigDetail8State();
}

class _ConfigDetail8State extends State<ConfigDetail8> {
  @override
