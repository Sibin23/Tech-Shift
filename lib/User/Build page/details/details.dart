...
class ConfigDetails9 extends StatefulWidget {
  final Map<String,dynamic> pc;
  final String totalAmt;
  const ConfigDetails9({super.key, required this.pc, required this.totalAmt});

  @override
  State<ConfigDetails9> createState() => _ConfigDetails9State();
}

class _ConfigDetails9State extends State<ConfigDetails9> {
  @override
  Widget build(BuildContext context) {
    ...
    String psu = custom['psu'];
    String psuPrice = custom['psuprice'];
    return Scaffold(
      appBar: AppBar(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              UiCustom.configDetail(context, name: psu, price: psuPrice),
              const SizedBox(height: 10),
