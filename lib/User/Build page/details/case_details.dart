...
class ConfigDetail6 extends StatefulWidget {
  final Map<String, dynamic> pc;
  final String totalAmt;
  const ConfigDetail6({super.key, required this.pc, required this.totalAmt});

  @override
  State<ConfigDetail6> createState() => _ConfigDetail6State();
}
