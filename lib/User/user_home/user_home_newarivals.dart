...
import 'package:prosample_1/User/user_home/user_home_newarivals_list.dart';
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text('New Arrival\'s', style: TextStyling.titleText),
          Text('All our New Arivals in an exclusive brand selection', style: TextStyling.categoryText),
          SizedBox(
              width: MediaQuery.of(context).size.width,
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (ctx) => const ProductNewArivalsList()));
            },
            child: Container(
