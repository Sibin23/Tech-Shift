...
class ProductGpu extends StatefulWidget {
  const ProductGpu({super.key});

  @override
  State<ProductGpu> createState() => _ProductGpuState();
}

class _ProductGpuState extends State<ProductGpu> {
  @override
