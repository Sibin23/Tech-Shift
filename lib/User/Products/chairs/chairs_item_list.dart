...
class ProductChair extends StatefulWidget {
  const ProductChair({super.key});

  @override
  State<ProductChair> createState() => _ProductChairState();
}

class _ProductChairState extends State<ProductChair> {
  @override
