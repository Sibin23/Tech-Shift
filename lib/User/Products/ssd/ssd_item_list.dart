...
class ProductSSD extends StatefulWidget {
  const ProductSSD({super.key});

  @override
  State<ProductSSD> createState() => _ProductSSDState();
}

class _ProductSSDState extends State<ProductSSD> {
  @override
