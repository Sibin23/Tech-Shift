...
class ProcessorDetailScreen extends StatefulWidget {
  final Map<String, dynamic> cpu;
  const ProcessorDetailScreen({super.key, required this.cpu});

  @override
  State<ProcessorDetailScreen> createState() => _ProcessorDetailScreenState();
}

class _ProcessorDetailScreenState extends State<ProcessorDetailScreen> {
  @override
        ...
        child: Row(
          ...
          children: [
            Container(
                ...
                child:
                    Center(child: Text('Buy Now', style: TextStyling.buttonB))),
            GestureDetector(
              onTap: () {
                final cpuSelected = {
                  'image': cpu['image'],
                  'name': cpu['name'],
                  'idnum': cpu['idnum'],
                  'oldprice': cpu['oldprice'],
                  'newprice': cpu['newprice'],
                  'category': cpu['category'],
                };
                addToCart(cpuSelected);
